...
> **Flowchart diagrams** are in [docs/how-it-works.md](docs/how-it-works.md) — GitHub renders them automatically. For a detailed offline reference, open `agent_flow_diagram.svg`.
